...
Object.assign(states, {
  ...
  Settings6: {
    ...
    default: "",
    valueChoices: ["PUSH_TO_TALK", "VOICE_ACTIVITY"],
  },
});
...
Object.assign(states, {
  ...
  Discord_Connected: {
    ...
    default: "",
    valueChoices: ["Connected", "Disconnected"],
  },
...
Object.assign(actions, {
  ...
  Discord_setnoiseSuppression: {
    ...
    tryInline: "true",
    format:
      "Discord: Set Noise Suppression {$discordNoiseSuppressionAction$} (Note: If using Krisp, this action seems to do nothing)",
    data: [
      {
    ...
    data: [
      {
        ...
        default: "Toggle",
        valueChoices: ["Voice Activity", "Push To Talk", "Toggle"],
      },
    ],
  },
  Discord_resetPTT: {
